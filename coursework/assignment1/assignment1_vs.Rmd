...
k5$cluster %>% table()
fviz_cluster(k5, data = ret_matrix, ellipse.type = "convex", geom = "point", ellipse.level = 0.95, repel = TRUE, main = "Kmeans with 5 Clusters",ggtheme = theme_minimal())

```
```{r}

# plot
k12 <- kmeans(ret_matrix, centers = 5, nstart = 20)

fviz_cluster(k12, data = ret_matrix, ellipse.type = "convex", geom = "point", ellipse.level = 0.95, repel = TRUE, main = "Kmeans with 12 Clusters",ggtheme = theme_minimal())
