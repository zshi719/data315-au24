...
<main>
    ...
    <div class="flex-container row">
        ...
        <div class="flex-container col">
            <div class="hist">
                <Histogram bind:filter={filter1} data={data} fullData={fullData} update={updateData}
                           variable={var1}></Histogram>
            </div>
            <div class="hist">
                <Histogram bind:filter={filter2} data={data} fullData={fullData} update={updateData}
                           variable={var2}></Histogram>
            </div>
        </div>
    </div>
</main>
